    ...
    <div style={{ minHeight: '100vh', background: '#f8fafc', fontFamily: 'Inter, system-ui', padding: '28px 20px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
          <div>
            ...
            <p style={{ margin: '3px 0 0', fontSize: 12, color: '#64748b' }}>
              ...
              {!myKey    && <span style={{ marginInlineStart: 8, color: '#ef4444', fontWeight: 600 }}>⚠️ Private key not found</span>}
              {!canSign  && <span style={{ marginInlineStart: 8, color: '#f97316', fontWeight: 600 }}>⚠️ Ed25519 not supported</span>}
            </p>
          </div>
        ...
        <div style={{ background: 'linear-gradient(135deg,#7c3aed,#2563eb)', borderRadius: 16, padding: '16px 22px', marginBottom: 22, color: '#fff', display: 'flex', alignItems: 'center', gap: 24 }}>
          ...
          <div style={{ marginInlineStart: 'auto', fontSize: 12, opacity: 0.85, display: 'flex', alignItems: 'center', gap: 6 }}>
