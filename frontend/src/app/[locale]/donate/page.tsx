...
export default async function DonatePage() {
  ...
  const ventureBenefits = t.raw('venture_benefits') as string[]
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#faf5ff', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto', padding: '64px 24px' }}>
        ...
        <section style={{ marginBottom: 48 }}>
          ...
          <div className="tiers-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, alignItems: 'stretch' }}>
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 10, fontWeight: 700, color: '#a78bfa', letterSpacing: '0.18em', textTransform: 'uppercase', marginBottom: 4, whiteSpace: 'nowrap' }}>
                  {t('venture_label')}
                </div>
                <div style={{ fontWeight: 900, fontSize: '1.6rem', color: '#fff', lineHeight: 1, marginBottom: 10, whiteSpace: 'nowrap' }}>
                  {t('venture_from')}
                </div>
                <ul style={{ margin: 0, padding: 0, listStyle: 'none', display: 'flex', flexWrap: 'wrap', gap: '4px 20px' }}>
                  {ventureBenefits.map(b => (
        ...
        {/* Russia payment section — только для ru */}
        {locale === 'ru' && <section style={{ marginBottom: 48 }}>
          <div style={{
            background: '#fff',
            ...
            <div style={{ flex: 1 }}>
              <h2 style={{ fontSize: '1.1rem', fontWeight: 900, color: '#111827', margin: '0 0 6px' }}>
                {t('russia_title')}
              </h2>
            ...
            <Link href={`/${locale}/payment`} style={{
              flexShrink: 0,
              padding: '12px 24px',
        ...
        <CryptoWallets
          title={t('crypto_wallets_title')}
          subtitle={t('crypto_wallets_subtitle')}
          warning={t('crypto_wallets_warning')}
        />
