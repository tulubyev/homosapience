...
const LINKS = [
  ...
  { href: '/solutions',  label: 'Solutions',   color: '#fb923c' },
  { href: '/pricing',    label: 'Pricing',     color: '#34d399' },
  { href: '/developers', label: 'Developers',  color: '#67e8f9' },
  { href: '/blog',       label: 'Blog',        color: '#f9a8d4' },
      ...
      <div style={{ maxWidth: 960, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16, marginBottom: 16 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap' }}>
            ...
            <Link href="/chat" title="Chat"
              style={{ color: '#f472b6', textDecoration: 'none', opacity: 0.85, display: 'flex', alignItems: 'center' }}>
              <ChatIcon />
            </Link>
            <a href="https://t.me/aptogon" target="_blank" rel="noopener noreferrer" title="Telegram"
              style={{ color: '#38bdf8', textDecoration: 'none', opacity: 0.85, display: 'flex', alignItems: 'center' }}>
              <TelegramIcon />
            </a>
            <a href="https://github.com/tulubyev/homosapience" target="_blank" rel="noopener noreferrer" title="GitHub"
              style={{ color: '#94a3b8', textDecoration: 'none', opacity: 0.85, display: 'flex', alignItems: 'center' }}>
              <GitHubIcon />
            </a>
          </div>
        </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.05)', paddingTop: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 8 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
            <p style={{ fontSize: 12, color: '#64748b', margin: 0 }}>Human Firewall for the Internet</p>
            <p style={{ fontSize: 12, color: '#64748b', margin: 0 }}>© 2025–26 Homo Sapience Internet · Open Source · AGPL-3.0 + Commercial</p>
          </div>
          <p style={{ fontSize: 12, color: '#64748b', margin: 0, flexShrink: 0 }}>
            v0.2.0 · Aptos Testnet
          </p>
        </div>
